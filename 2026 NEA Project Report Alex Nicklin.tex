...
SimpleQtLogger is LGPL code by Mario Ban, 2015. https://github.com/Mokolea/SimpleQtLogger
...
\begin{itemize}
    \item Download QT from https://www.qt.io/download-qt-installer-oss
    \item Download MiKTeX from https://miktex.org/download
    \item Set to check/install updates automatically. Wait until it says updates are avaiable and do those
    \item Git from https://git-scm.com/install/windows
    \item CLion from https://www.jetbrains.com/clion/download/?section=windows
    \item Install the CLion extensions TeXiFy-IDEA and intellij-pdf-viewer
    \item Restart CLion
    \item Update all CLion Plugins
    \item Clone Repository https://github.com/Thentoxd/MediaFileRenamer
    \item MinGW toolchain dialog should appear - Click Next
    \item In the profile, add the following CMAKE options: "-DCMAKE_PREFIX_PATH=C:\Qt\6.9.3\mingw_64\lib\cmake"
...
Before trying to edit the documentation (.tex file) I would Restart your computer at this point.

To edit the documentation:

\begin{itemize}
    \item Under \Documentation\Project Report
...
\subsection{Legal}
All my source code is available under the GPL licence.
...
This Documentation was written in Latex.  There are a number of cross-platform implementations, I used MiTex. https://miktex.org/download

I use the CLion IDE from JetBrains with the TeXiFy-IDEA plugin.
