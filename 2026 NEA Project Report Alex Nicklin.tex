...
\begin{itemize}
    ...
    \item In the profile, add the following CMAKE options: \begin{verbatim}"-DCMAKE_PREFIX_PATH=C:\Qt\6.9.3\mingw_64\lib\cmake"\end{verbatim}
...
spdlog is used as a logging library. https://github.com/gabime/spdlog
