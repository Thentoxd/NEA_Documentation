...
\textit{The C++ tooling ecosystem is a fractal nightmare of unbridled chaos} \url{https://github.com/marzer/tomlplusplus}
...
\begin{enumerate}
   ...
   \item 2026NEAProjectReportAlexNicklin.bib
\end{enumerate}

[1] is the Latex source file for the report and [2] is the bibliography.

We used BibTeX and MikTeX to compile these two source files to make the final, single report file in pff format.
