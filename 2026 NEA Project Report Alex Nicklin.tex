...
\begin{itemize}
    \item spdlog is used as a logging library. https://github.com/gabime/spdlog
\end{itemize}
...
MediaFileRenamer has been written in C++ using the QT 6 cross-platform UI library.
...
\begin{itemize}
    \item Install QT from https://www.qt.io/download-qt-installer-oss
    \item Install Git from https://git-scm.com/install/windows
    \item Install CLion from https://www.jetbrains.com/clion/download/?section=windows
    \item Update all CLion Plugins
    \item Clone the MediaFileRenamer repository from https://github.com/Thentoxd/MediaFileRenamer
...
\smallskip
spdlog is used as a logging library. https://github.com/gabime/spdlog. Code uses the MIT licence, so can be used in both open source and proprietry programs.


\subsection{Runtime Logging}
spdlog is used as a logging library. https://github.com/gabime/spdlog. This has been setup to provide one stream of messages that get sent to the console and to a three rotating 5Mb log files.
...
\bigskip
\includegraphics[width=0.8\textwidth]{Media/2025-10-23 11_15_40 logging.jpg}
...
\begin{itemize}
    ...
    \item Within CLion ... Under \Documentation\Project Report
